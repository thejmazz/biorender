...
/***/ function(module, exports, __webpack_require__) {
	...
	var makePiecesMito = function () {
	    ...
	    return regeneratorRuntime.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            _context.next = 2;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/Mitochondria/mitochondria.obj');
	  ...
	  return function makePiecesMito() {
	...
	var makeUnifiedMito = function () {
	    ...
	    return regeneratorRuntime.wrap(function _callee2$(_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            _context2.next = 2;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/Mitochondria/mitochondria_unified.obj');
	  ...
	  return function makeUnifiedMito() {
	    return ref.apply(this, arguments);
	  };
	}();
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          case 0:
	            ...
	            // scene.add(porin)
	            _context3.next = 6;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/ETC/etc2-0.1.obj');
	
	          case 6:
	            _context3.t0 = _context3.sent;
	            etc2 = (0, _etcCentered.constructETC2)(_context3.t0);
	            _context3.next = 10;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/ETC/etc2-0.05.obj');
	
	          case 10:
	            _context3.t1 = _context3.sent;
	            etc2med = (0, _etcCentered.constructETC2)(_context3.t1);
	            _context3.next = 14;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/ETC/etc2-0.01.obj');
	
	          case 14:
	            _context3.t2 = _context3.sent;
	            etc2low = (0, _etcCentered.constructETC2)(_context3.t2);
	            _context3.next = 18;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/ATP-Synthase/ATP-Synthase2-0.1.obj');
	          ...
	          case 18:
	            ...
	            _context3.next = 24;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/ATP-Synthase/ATP-Synthase2-0.05.obj');
	          ...
	          case 24:
	            ...
	            _context3.next = 30;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/ATP-Synthase/ATP-Synthase2-0.01.obj');
	          ...
	          case 54:
	            ...
	            _context3.next = 73;
	            return (0, _loaders.OBJLoaderAsync)('http://biorender/github.io/models/Mitochondria/Outer-Membrane/porin.obj');
	...
	var _scene = __webpack_require__(295);
	...
	var scene = _createScene.scene;
	var camera = _createScene.camera;
	var renderer = _createScene.renderer;
	...
	var sceneGraph = (0, _scene2.default)();
	...
	try {
	  for (var _iterator = Object.keys(sceneGraph)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    var obj3DKey = _step.value;
	
	    var obj3D = sceneGraph[obj3DKey];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stats = __webpack_require__(294);
	...
	var createScene = exports.createScene = function createScene(_ref) {
	  var _ref$W = _ref.W;
	  var W = _ref$W === undefined ? window.innerWidth : _ref$W;
	  var _ref$H = _ref.H;
	  var H = _ref$H === undefined ? window.innerHeight : _ref$H;
	  ...
	  var close = _ref$close === undefined ? 0.01 : _ref$close;
	  var _ref$far = _ref.far;
	  var far = _ref$far === undefined ? 100000 : _ref$far;
	  var _ref$clearColor = _ref.clearColor;
	  var clearColor = _ref$clearColor === undefined ? 0xffffff : _ref$clearColor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lights = __webpack_require__(296);
	...
	exports.default = function () {
	  var _lightsCreator = (0, _lights2.default)();
	
	  var pLight = _lightsCreator.pLight;
	
	
	  var boxGeom = new THREE.BoxGeometry(1, 1, 1);
	  var normalMat = new THREE.MeshLambertMaterial({ color: 0x9cfba0 });
	
	  var box = new THREE.Mesh(boxGeom, normalMat);
...
/***/ function(module, exports) {
	...
	// TODO reject
	var OBJLoaderAsync = exports.OBJLoaderAsync = function OBJLoaderAsync(url) {
...
/***/ function(module, exports) {
	...
	var makeLOD = exports.makeLOD = function makeLOD(_ref) {
	  var meshes = _ref.meshes;
	  var distances = _ref.distances;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var crudeSynthaseCreator = exports.crudeSynthaseCreator = function crudeSynthaseCreator() {
	  ...
	  var rotor = new THREE.Mesh(new THREE.CylinderGeometry(0.005, 0.005, 0.04, 16), new THREE.MeshLambertMaterial({ color: 0x2fc37f }));
	  rotor.position.set(0, 0.035, 0);
	  synthase.add(rotor);
	
	  var head = new THREE.Mesh(new THREE.SphereGeometry(0.02, 16, 16), new THREE.MeshLambertMaterial({ color: 0xc4caf4 }));
	...
	var crudeDimerCreator = exports.crudeDimerCreator = function crudeDimerCreator() {
	  var angle = arguments.length <= 0 || arguments[0] === undefined ? Math.PI / 8 : arguments[0];
	  var spread = arguments.length <= 1 || arguments[1] === undefined ? 0.04 : arguments[1];
	  var synthase = arguments[2];
	...
	var constructDimer = exports.constructDimer = function constructDimer(synthase) {
	  ...
	  var ATPSynthaseDimer = new dimerCreator(0.1, ATPSynthase);
	...
	var constructSynthase = exports.constructSynthase = function constructSynthase(object) {
	  ...
	  components.forEach(function (component) {
	    return ATPSynthase.add(component);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.constructCristae = undefined;
	...
	var constructCristae = exports.constructCristae = function constructCristae(group) {
	  ...
	  group.children.forEach(function (child) {
	    ...
	    if (child.name === 'Cristae.Curved') {
	      ...
	      (0, _UVUtil.assignUVs)(child.geometry);
	      ...
	      for (var i = 0; i < child.geometry.faces.length; i += 2) {
	        child.geometry.faceVertexUvs[0].push([new THREE.Vector2(0, 0), new THREE.Vector2(0, 1), new THREE.Vector2(1, 0)]);
	        child.geometry.faceVertexUvs[0].push([new THREE.Vector2(0, 1), new THREE.Vector2(1, 1), new THREE.Vector2(1, 0)]);
	      }
	  ...
	  return { curved: curved, etc: etc, rim: rim };
	};
...
/***/ function(module, exports) {
	...
	var assignUVs = exports.assignUVs = function assignUVs(geometry) {
...
/***/ function(module, exports) {
	...
	var constructETC = exports.constructETC = function constructETC(group) {
	  var materialMappings = {
